<div class="field-group {#required}required{/required}" data-type="radio">
    ...
    <div class="preview">
        ...
        <div class="options" data-type="radio-option">
            <label class="radio-inline option">
                <input type="radio" name="radio-opt" class="option-1" disabled />
                <span class="option-label">Option 1</span>
            </label>
            <label class="radio-inline option">
                <input type="radio" name="radio-opt" class="option-2" disabled />
    ...
    <div class="settings">
        ...
        <div class="form-horizontal">
            ...
            <ul class="options-settings col-sm-offset-3" data-type="radio-option-setting">
                
                <!-- Radio options' settings will be loaded here -->
